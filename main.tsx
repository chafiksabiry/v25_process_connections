...
registerMicroApps([
  ...
  {
    name: 'auth',
    entry: 'https://harx26register-rollback.netlify.app',
  ...
  {
    name: 'company',
    entry: 'https://harx26comporchestrator-rollback.netlify.app/',
  ...
  // },
  {
    ...
    name: 'reps',
    entry: 'https://harx26reporchestrator-rollback.netlify.app/',
