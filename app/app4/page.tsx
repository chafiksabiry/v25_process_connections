...
import { googleApi, type GoogleSearchResult } from '../../components/CompanySearch/api/google';
import { generateCompanyProfile, searchCompanyLogo, type CompanyProfile } from '../../components/CompanySearch/api/openaiBackend';
import { CompanyProfilePageModern as CompanyProfilePage } from '../../components/CompanySearch/CompanyProfilePageModern';
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-gray-900"
            />
            <button
                  ...
                  if (!logoUrl) {
                    const fetchLogo = async () => {
                      try {
                        ...
                        if (aiLogoUrl) {
                          setLogoCache(prev => ({ ...prev, [cacheKey]: aiLogoUrl as string }));
                          return aiLogoUrl;
                        }
                        // Fallback Clearbit
                        if (domain) {
