...
import api from '@/lib/rep-profile/client'; // Use unified api client
...
export function WelcomeMessage({ type, onClose }: WelcomeMessageProps) {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      // Assuming api client handles base URL
      ...
      <div className="bg-white rounded-3xl w-full max-w-3xl p-8 md:p-12 relative shadow-2xl border border-gray-100 card-hover">
        ...
        <div className="text-center">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-all flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
            {loading ? (
              <>
